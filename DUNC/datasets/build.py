...
from .chunk01 import CUHK01

__factory = {'CUHK-PEDES': CUHKPEDES, 'ICFG-PEDES': ICFGPEDES, 'RSTPReid': RSTPReid, 'CUHK01': CUHK01}
...
def collate(batch):
    ...
    for k, v in dict_batch.items():
        if isinstance(v[0], int):
            ...
            raise TypeError(f"Unexpect data type: {type(v[0])} {k} in a batch.")
